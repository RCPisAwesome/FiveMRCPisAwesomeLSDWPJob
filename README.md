...
Given the opportunity of being a developer, I would also like to take this one step further, playing a character who runs the LSDWP. I would be managing the 3 LSDWP sites in Vinewood, Rancho and Zancudo above the military/AIRX base. I would be roleplaying my character based on the information that can be found on the [GTA Fandom Wiki](https://gta.fandom.com/wiki/Los_Santos_Department_of_Water_%26_Power). I would have the duty of assigning jobs to employees instead of it being a fully open job, to put it bluntly I would keep the grinders at bay as the job could be very overpowered if farmed, given the items you can potentially receive. Alternatively the items and pay you're able to receive could depend on if your a whitelisted employee of the LSDWP or not. Some other duties could be getting the vehicles repaired at mechanic shops, there would be a shared garage similar to that of the PD on NoPixel. This could also allow players to buy and use their own LSWDP vehicles so they could upgrade and personalise them.

On top of all the aforementioned points there is much more potential with the illegal side of this job, which my character would be fully aware of. Players could sell me the items they get at a slightly better price than the existing sale spot, commonly referred to as the "fence". On top of that, with a little modification to the code, it would be possible to give players specific job locations and receive specific items from them. This would be a very good method of distributing and selling illegal weapons and items as the job would act as a good cover. This could even be a way of getting gun part items, or materials the same as the existing gun crafting, which then could be sold to me and I could craft them into functioning weapons, without the employees knowledge of course. Although gun crafts already exist it doesn't hurt to have competition or variety in weapons. This crafting area could be in an interior linked to a door on any and all the 3 LSDWP sites, they all have suitable buildings. It would also be nice to clean up the textures and improve each of the areas with like cleaning up the rubbish, add more buildings and add fences. I could do these changes personally, but that it not as important as the mechanics.
